  ...
  private phases: Phase[] = [
    {
      ...
      tips: [
        '“Lembre-se: um caso de uso sempre representa uma funcionalidade oferecida pelo sistema, vista da perspectiva do usuário. Se você não consegue descrever a ação com um verbo, talvez não seja um caso de uso!”',
      ...
      type: 
        {
          ...
          description: 'Nesta fase, você encontrará um diagrama parcialmente construído. Seu objetivo é completar os elementos que faltam para que ele represente corretamente o cenário proposto. Pense bem antes de adicionar cada componente para garantir que o resultado final esteja correto!'
        },
      level: 'MEDIUM',
      correctDiagramsJson: 
      [
